...
document.getElementById("sliderNumCenter").onclick = function () {
  ...
  document.getElementById('lableNumCenter').innerHTML = "Number of clusters: " + value.toString();
  numCenter = value;
}
...
document.getElementById("create").addEventListener("click", clearCanvas);
...
document.getElementById("clear").addEventListener("click", clearStroke);
...
document.getElementById("setPoint").addEventListener("click", function (){
...
document.getElementById("kMedium").addEventListener("click", kMedium);
...
document.getElementById("ostovClusterizations").addEventListener("click", ostovClusterizations);
...
document.getElementById("compareClusterizations").addEventListener("click", compareClusterizations);
